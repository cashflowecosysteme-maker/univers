...
function normalizeLegacyProject(raw={},project={}){
  ...
  for(const k of wanted){
    ...
    out.agents.push({
      ...
      voiceEnv:envName,placement:legacyFirst(saved.placement,saved.position,saved.emplacement,'principal'),
